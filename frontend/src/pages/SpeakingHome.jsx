...
import {
  Sparkle, Compass, Microphone, Waveform, ClockCountdown, CheckCircle,
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <div className="flex flex-col rounded-3xl border border-violet-100 bg-white p-6 shadow-soft transition hover:shadow-xl hover:shadow-violet-200/50">
            ...
            <p className="mt-4 text-sm leading-relaxed text-gray-600">
              Record one answer at a time and get instant feedback. No timer, no pressure.
            </p>
            <ul className="mt-4 space-y-2 text-sm text-gray-600">
              <li className="flex items-center gap-2"><CheckCircle size={16} weight="fill" className="shrink-0 text-primary" /> Pick a task type and theme</li>
              <li className="flex items-center gap-2"><CheckCircle size={16} weight="fill" className="shrink-0 text-primary" /> Transcribed answer + corrections</li>
              <li className="flex items-center gap-2"><CheckCircle size={16} weight="fill" className="shrink-0 text-primary" /> Suggestions to improve</li>
            </ul>
            <button onClick={startPractice}
              className="btn-primary mt-6 w-full justify-center !bg-gradient-to-r !from-primary !to-fuchsia-600">
              <Microphone size={18} weight="fill" /> Start practice
            </button>
          </div>
