    ...
    <main className="overflow-x-clip bg-white">
      ...
      <section className="mx-auto max-w-5xl px-4 pt-10 sm:px-6">
        <div className="mb-6 text-center">
          <h2 className="font-heading text-2xl font-extrabold text-gray-900">Reading — choose how you want to work</h2>
          <p className="mx-auto mt-2 max-w-lg text-sm text-gray-600">
            Practice comprehension passages one at a time, or sit a full timed reading test.
          </p>
        </div>
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          ...
          <div className="flex flex-col rounded-3xl border border-violet-100 bg-white p-6 shadow-soft transition hover:shadow-xl hover:shadow-violet-200/50">
            ...
            <p className="mt-4 text-sm leading-relaxed text-gray-600">
              Work through reading passages one at a time and check your answers instantly.
            </p>
            <ul className="mt-4 space-y-2 text-sm text-gray-600">
              <li className="flex items-center gap-2"><CheckCircle size={16} weight="fill" className="shrink-0 text-primary" /> Passage + multiple-choice questions</li>
            ...
            <button onClick={startPractice}
              ...
              <BookOpen size={18} weight="fill" /> Start practice
            </button>
          </div>
