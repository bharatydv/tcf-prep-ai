      ...
      <div className="card w-full max-w-md p-8">
        ...
        <form onSubmit={submit} className="mt-6 space-y-4">
          <div className="relative">
            ...
            <input className="input !pl-11" type="email" required placeholder={t('auth.email')} value={email}
              onChange={(e) => setEmail(e.target.value)} data-testid="email-input" />
          </div>
          <div className="relative">
            <Lock size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" />
            <input className="input !pl-11" type="password" required placeholder={t('auth.password')} value={password}
