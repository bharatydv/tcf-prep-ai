...
WRITING_EXAM_SETS = [
    ...
    ("Vous avez récemment participé à une activité intéressante. Écrivez à un ami pour raconter votre expérience et lui expliquer pourquoi vous avez aimé cette activité.",
    ...
    ("Vous avez obtenu une promotion au travail. Écrivez à vos amis pour leur annoncer la nouvelle et proposer de célébrer ensemble.",
    ...
    ("Vous avez découvert une bibliothèque idéale pour étudier. Écrivez à votre ami pour lui présenter le lieu et lui proposer d’y aller ensemble.",
    ...
    ("Vous organisez une sortie entre collègues après le travail. Écrivez un message pour proposer une activité et demander qui souhaite participer.",
    ...
    ("Vous préparez un examen important avec vos amis. Écrivez-leur pour proposer un programme de révision et préciser quand et où vous allez travailler.",
    ...
    ("Vous avez découvert un nouveau parc dans votre quartier. Écrivez à votre ami pour lui présenter cet endroit et lui proposer d’y aller ensemble.",
    ...
    ("Vous souhaitez organiser une soirée cinéma chez vous. Écrivez à vos amis pour les inviter et présenter le programme de la soirée.",
    ...
    ("Vous souhaitez organiser une journée entre amis sans dépenser beaucoup d’argent. Écrivez-leur pour proposer plusieurs activités gratuites et expliquer votre organisation.",
    ...
    ("Vous avez récemment visité une exposition, un musée ou un événement culturel. Écrivez à un ami pour raconter votre expérience et lui recommander cette activité.",
